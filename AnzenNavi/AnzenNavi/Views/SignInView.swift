...
struct LoginView : View{
    ...
    @State private var showPhoneNumberLogin: Bool = false // Phone number login sheet display
    ...
    var body: some View {
        ZStack(alignment: .bottom){
            ...
            VStack(alignment: .leading){
                ...
                Button(action: {
                    showPhoneNumberLogin = true // Display phone number login view
                }, label:{
                ...
                .sheet(isPresented: $showPhoneNumberLogin) {
